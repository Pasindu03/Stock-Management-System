...
import org.example.sms.tm.CustomerTM;
...
public class CustomerManageFormController implements Initializable {
    ...
    public void txtIdOnKeyReleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.CUSTOMER_ID_PATTERN).matcher(txtId.getText()).matches()){
    ...
    public void txtNICOnKeyreleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.CUSTOMER_NIC_OLD_PATTERN).matcher(txtNIC.getText()).matches() || Regex.getInstance().getPattern(RegexTypes.CUSTOMER_NIC_NEW_PATTERN).matcher(txtNIC.getText()).matches()){
