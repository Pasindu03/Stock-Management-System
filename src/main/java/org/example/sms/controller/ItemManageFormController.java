...
import org.example.sms.tm.ItemTM;
...
>>>>>>> 76e59a66fbd2aad1e7a7519dda9613cda3650dfd
    ...
    public void TxtQtyOnKeyReleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.INT_PATTERN).matcher(TxtQty.getText()).matches()){
    ...
    public void txtCodeOnKeyReleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.ITEM_ID_PATTERN).matcher(txtCode.getText()).matches()){
    ...
    public void txtGetPriceOnKeyReleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.DOUBLE_PATTERN).matcher(txtGetPrice.getText()).matches()){
    ...
    public void txtSellPriceOnKeyReleased(KeyEvent keyEvent) {
        if (Regex.getInstance().getPattern(RegexTypes.DOUBLE_PATTERN).matcher(txtSellPrice.getText()).matches()){
